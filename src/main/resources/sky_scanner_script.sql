create
database if not exists sky_scanner;
use
sky_scanner;
...
insert into airport(airport_name, city, country, airline_id)
values ('Dubai International Airport', 'Dubai', 'United Arab Emirates', 4),
...
insert into flight(airplane_name, allowed_baggage_in_kilogrms,
                   departure_airport_id, arrival_airport_id, airline_id)
values ('airbus_a310', 12, 3, 1, 1),
       ('boeing_737', 14, 1, 2, 2),
       ('boeing_737', 14, 5, 3, 2),
...
insert into ticket(flight_id, price_in_uah)
values (3, 1000),
       (5, 3400),
       (7, 570),
       (8, 5000),
...
insert into user_profile(user_name, surname)
values ('John', 'Brown'),
       ('Bogdan', 'Khmelnytskyy'),
       ('Andriy', 'Baker'),
       ('Stepan', 'Bandera'),
...
insert into user_profile_has_ticket(user_profile_id, ticket_id)
values (8, 3),
       (1, 3),
       (4, 9),
       (5, 7),
...
create
index user_name_surname on user_profile(user_name, surname);
create
index flight_baggage_max_weight on flight(allowed_baggage_in_kilogrms);
